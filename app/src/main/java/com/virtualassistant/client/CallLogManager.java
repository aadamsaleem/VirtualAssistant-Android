...
public class CallLogManager {
    ...
    public static void sendAllLog(Context context, final String playerId) {
    ...
    public static void sendTodaysLog(Context context, final String playerId) {
        ...
        try {
            ...
            while (managedCursor.moveToNext()) {
                ...
                calendar.setTimeInMillis(Long.parseLong(managedCursor.getString(date)));
